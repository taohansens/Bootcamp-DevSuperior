            ...
            <div className="card-base border-radius-20 product-details">
                ...
                <div className="row">
                    <div className="col-6 pr-5">
                        ...
                        <h6 className="product-details-name">
                            Computador Desktop - Intel Core i7
                        </h6>
                        <ProductPrice price='2.779,00' />
                    </div>
                    <div className="col-6 product-details-card border-radius-20">
                        ...
                        virtuais para obter mais espaço e trabalhar com os itens que você deseja. Além disso, todas as notificações e principais configurações são reunidas em uma única tela de fácil acesso.
                        </p>
